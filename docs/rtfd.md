...
By default, the [puppet-dhcp](https://github.com/ULHPC/puppet-dhcp) repository is bound to the [ulhpc-puppet-dhcp](http://ulhpc-puppet-dhcp.rtfd.org) project on Read the Docs (to avoid confusion with other dhcp projects). 
